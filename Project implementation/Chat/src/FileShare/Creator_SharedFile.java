...
*/
public class Creator_SharedFile extends javax.swing.JFrame
{
    ...
    public Creator_SharedFile(FileServer root, String ownerNick, String ownerIp, String ownerPort)
    {
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if(selection == JFileChooser.APPROVE_OPTION)
                {
                    ...
                    ShowWaitAction action = new ShowWaitAction("WaitAction", Creator_SharedFile.this,"Selecting available files...", new Runnable() {
                        @Override
                        public void run() {
                           Creator_SharedFile.this.allSize = Creator_SharedFile.this.fillDlm(selectedFiles);
                           Creator_SharedFile.this.fillSelectedFileArr();
                        }
                    });
