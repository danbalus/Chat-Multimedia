...
public class Creator_Server extends javax.swing.JDialog
{
    ...
    private String nameServerReceive;
    
    /**
      Creates new form CreateNewServer
     */
    public Creator_Server(Container root, String nameToCreate2)
    {
    	
        super((Window)root);
        nameServerReceive = nameToCreate2;
       // System.out.println("oare? " + nameToCreate2 );
        initComponents();
        ...
        this.root = root;
       // nameServerReceive = Creator_Server.this.nameServerReceive;
        //txt_ServerName.setText(nameClient);
        ShowWaitAction setup = new ShowWaitAction("Wait action", root, "Checking Your Network Connection...", new Runnable() {
            ...
            public void run() {
                ...
                Creator_Server.this.txt_ServerName.setText(nameToCreate2);
    ...
    private void initComponents() {
    	nameServerReceive = new String();
        jLabel1 = new javax.swing.JLabel();
        txt_ServerName = new javax.swing.JTextField();
       // txt_ServerName = new javax.swing.JTextField(nameServerReceive);
        //System.out.println("-----------------" + nameServerReceive);
        ...
        //txt_ServerName.setText(nameServerReceive);
        txt_ServerName.setNextFocusableComponent(cmb_ConnectionType);
        //txt_ServerName.setText("aaa");
	...
	public void setNameOfLogin(String nameToCreate) {
		// TODO Auto-generated method stub
		
		nameServerReceive = nameToCreate;
		System.out.println("nameServerReceive " + nameServerReceive);
