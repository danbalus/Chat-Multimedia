...
/**Main control and GUI class of File chat App but authentication.
 * 
 */
public class Monitor extends javax.swing.JFrame implements FileChatConstants
{
    ...
    public AudioNotif an;//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public HistoryFrame hf;//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public History hist;//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public ClientDAO cli;//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public String clientOrServer;
    public String msj;//mesajul trimis ce nu va contine @...
    //public String []receiver = new String[10];//cel ce va primi mesajul
    ...
    public Monitor(String xx )
    {
       //this.nameToCreate = nameToCreate;
        ...
        setup();
        createNewClientGui = new Creator_Client(this, xx);
        //System.out.println("oare -1?" + nameToCreate);
        svCreater = new Creator_Server(Monitor.this, xx);
    	//svCreater.setNameOfLogin(nameToCreate);//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    private void initComponents() {
        ...
        JMenuItem menuItem_LimitUpload = new javax.swing.JMenuItem();
        ...
        menuItem_History = new javax.swing.JMenuItem();  //**********************************************************************************************
        ...
        menuItem_CreateRoom.setText("Create Server");
        ...
        menuItem_LimitUpload.setText("Limit Upload Speed");
        menuItem_LimitUpload.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuItem_LimitUploadActionPerformed(evt);
            }
        });
        jMenu3.add(menuItem_LimitUpload);
        ...
        //========menu 4=========================================================================================================================
        jMenu4.setText("Conversation");
        menuItem_History.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        menuItem_History.setText("History");
        menuItem_History.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	menuItem_HistoryActionPerformed(evt);
            }
        });
        jMenu4.add(menuItem_History);
        ...
        if(this.sv != null)
        {
            ...
            do
            {
                ...
                if (FileChat.monitor.clientNameList.contains(sName)) {
                    JOptionPane.showMessageDialog(this, "This name is used !");
                    sName = "";
                }
            }while(sName.isEmpty());
        ...
        SwingUtilities.invokeLater(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    if(text.length() > 0)
                    {
                        ...
                        {
                            if(searchType == 2 && Tool.isNumeric(text))
                            {
    ...
    {//GEN-HEADEREND:event_sndButtonActionPerformed
        ...
        msj = message.substring(message.indexOf(" ") + 1);//elimin @si numele
        //smessage.indexOf(" ");
        ...
        if(message.charAt(0) == '@')
        	receiver.add(0, message.substring(1, message.indexOf(" ")));//de la inceput pana la primul spatiu
        else
        	for(int i = 0; i < list_OnlineUser.getModel().getSize(); i++)
        	{
        		receiver.add(i, list_OnlineUser.getModel().getElementAt(i));
        	}
        
        System.out.println("receiver" + Arrays.toString(receiver.toArray()));//==================================================================================================)()()()()()()()()
        System.out.println("lung  " + receiver.size());
        
        
        //System.out.println("clientNameList" + Arrays.toString(clientNameList.toArray()));
        if(!message.isEmpty())
        if(this.cl != null)
        {
        	clientOrServer = this.cl.cName;
        ...
        cli.insert(clientOrServer, receiver, msj, getTimeText());//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        
        receiver.clear();//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        System.out.println("clientOrServer  " + clientOrServer);
        ...
        SwingUtilities.invokeLater(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    repaint();
                    revalidate();
                	//hf.dispatchEvent(new WindowEvent(hf, WindowEvent.WINDOW_CLOSING));
                    //upload_History();
                }
            });
...
// If there is opened connection asks for disconnect. 
    ...
    public void upload_History(){
    	
    	 cli = new ClientDAO();
    	 hist = new History(cli);
    	 hf = new HistoryFrame(hist, clientOrServer, serverActive);
    	 //hf.play();
    ...
    private void menuItem_HistoryActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_menuItem_HistoryActionPerformed
    {//GEN-HEADEREND:event_menuItem_HistoryActionPerformed
       //hf.play();//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      // SwingUtilities.invokeLater(new Runnable() {
      //     @Override
      //     public void run() {
    ...
    }//GEN-LAST:event_menuItem_HistoryActionPerformed
    ...
    {//GEN-HEADEREND:event_menuItem_SearchActionPerformed
    ...
    private void menuItem_LimitUploadActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_menuItem_LımıtUploadActionPerformed
     ...
     * Sockets, FileServer, Audio file etc.
     */
    ...
    *It uses shared file list to refresh. Not connects the server to get list.*/
    ...
    public void sendAcceptDownload(SharedFile shFile)//Download accept and download.
    {
        ...
        try {
            ...
            if(isAccepted)//If the image is still downloadable, the download is initiated.
            {
    ...
    *If its not accepted upload will be canceled.*/
    ...
    /* Fundemental Upload and Download algorithm.
     * 
    downloader -> file download -> getted confirmation -> start download
    ------------
    uploader -> file request -> sended confirmation -> getted confirmation -> start upload
    */
     ...
     * @param file 
     */
    public void newDlView(SharedFile file)//A new dl View is created. If a previously downloaded file is used, it will be replaced with the same view.
    {
    ...
    /**
     * Returns current time with format (yyyy.MM.dd G 'at' HH:mm:ss z)
     * @return 
     */
    ...
    private javax.swing.JMenuItem menuItem_History;
    ...
    private javax.swing.JMenuItem menuItem_LimitUpload;
	...
	public void setNameUserMonitor(String nameToSend) {
		// TODO Auto-generated method stub
		
		nameToCreate = nameToSend;
