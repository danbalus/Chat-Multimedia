...
public class Server implements Runnable,FileChatConstants
{
    ...
    {
        //System.out.println("a inrtat in server");
        this.sName = sName;
                ...
                for (ClientConnection clientConnection : clientList) {
                 ...
                 try {
                	 an.playOutgoing();//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                       ...
                       FileChat.monitor.addNewMessage("-------------------->   LOST CONNECTION !!!   <-----------------------------");
    ...
    public void sendPrivateMessage(String messageString)
    {
        ...
        {
            FileChat.monitor.addNewMessage("--> "+name+" DanB <--");
        }else
        {
            for (ClientConnection cConn : FileChat.monitor.sv.clientList) {
                ...
                {
                    try {
                        cConn.sendMessage("*PM FROM "+this.sName+" :"+privateMessage);
